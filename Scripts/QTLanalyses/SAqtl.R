...
SA1df <- read_excel("ALL_211_RILs/SA1.xls")
SA2df <- read_excel("ALL_211_RILs/SA2.xls")
...
geno<- read.csv("BayxSha_edit2_geno.csv")
...
setwd("/Users/marielelensink/Documents-local/SalicylicAcid/SAqtl")
...
#########GET EFFECT SIZES, UNDER CONSSTRUCTION#########
effect_SA <- scan1coef(pr_SA, bayxsha_SA$pheno)
plot(effect_SA, map_SA, columns=1:3)
#######################################################
#find peaks
...
fwrite(peaks_SA,"Data/QTLAoutput/SA_peakssave_final.txt")
