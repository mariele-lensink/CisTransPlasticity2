...
SW1df <- read_excel("ALL_211_RILs/sw1.xls")
SW2df <- read_excel("ALL_211_RILs/sw1.xls")
...
#########################################################################
#########QTL ANALYSIS########################
setwd("/Users/marielelensink/Documents-local/SalicylicAcid/SWqtl")
...
plot_scan1(out_SW,map_SW,lodcolumn = "AFFX.DapX.5_at")


#find peaks
peaks_SW<-find_peaks(out_SW, map_SW, threshold=2, drop = 1.5)
fwrite(peaks_SW,"Data/QTLAoutput/SW_peaks_save_final.txt")
